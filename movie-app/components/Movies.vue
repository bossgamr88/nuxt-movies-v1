...
export default {
  ...
  methods: {
    async getMovies() {
      ...
      // "https://api.themoviedb.org/3/movie/now_playing?api_key=d3de84b80bb26bc66fdf225d5f5593fd&language=en-US&page=1"
      const response = await axios.get(
        "https://api.themoviedb.org/3/movie/now_playing?api_key=d3de84b80bb26bc66fdf225d5f5593fd&language=th-TH&page=1"
      );
    ...
    async searchMovies() {
      this.isLoading = true;
      const response = await axios.get(
        `https://api.themoviedb.org/3/search/movie/?api_key=d3de84b80bb26bc66fdf225d5f5593fd&language=th-TH&page=1&query=${this.search}`
      );
